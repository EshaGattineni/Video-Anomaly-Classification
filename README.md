...
* Code and Implementation to the project can be foud here: [Notebook](https://github.com/BhargavMaganti/Video-Anomaly-Classification/blob/main/anomaly-detection-starter.ipynb)
